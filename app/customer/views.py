...
from customer.models import StoreAPIKey, EmailSubscription
...
class UnsubscribeEmailView(GenericAPIView):
    ...
    def post(self, request):
        ...
        except EmailSubscription.DoesNotExist as e:
            return Response(data={"success": False, "message": "Email does not exist"}, status=status.HTTP_400_BAD_REQUEST)
